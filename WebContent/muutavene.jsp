...
$(document).ready(function(){
	...
	//Haetaan muutettavan veneen tiedot
	var tunnus = requestURLParam("tunnus"); //Funktio löytyy scripts/main.js 	    
	$.getJSON({url:"HaeVene", data:{tunnus: tunnus}, success:function(result){	//Tiedot kulkevat palvelimelta GET-metodilla JSON-muodossa	
